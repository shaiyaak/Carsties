...
public class SearchController:ControllerBase
{
    ...
    {
         //Console.WriteLine($"SearchTerm: {searchTerm}, Page: {pageNumber}, Size: {pageSize}");
        ...
        // var pageCount = totalCount/searchParams.PageSize;
        // if (totalCount % searchParams.PageSize > 0) pageCount++;
        return Ok(new 
        {
